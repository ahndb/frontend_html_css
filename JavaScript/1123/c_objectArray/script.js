...
object.favorit = object.favorit || '떡볶이';
console.log(object.favorit);

//! 2. 배열 기반의 다중 할당
// : 배열과 비슷한 방법으로 할 번에 여러 개 의 변수에 값을 할당
...
// name속성을 aaa라는 이름, price 속성을 bbb라는 이름 꺼내옴
...
// : 앝은 복사(참조 복사)는 서로 이름만 다를 뿐 서로 같은 메모리 참조값을 가짐 
...
const 추가구매 = ['감자, 오렌지주스'];
const 물건_1126 = ['양파', ...물건_1125,'감자', ...추가구매];
console.log(물건_1126);
