...
// if문, swich문 등등 문으로 끝나는 키워드들은 statement의 문장에서 나온 의미
...
// 식별자 뒤에 괄호가 없는 경우: 변수(단독 사용), 속성(다른 식별자와 사용)
// 식별자 뒤에 괄호가 있는 경우: 함수(단독 사용), 메소드(다른 식별자와 사용)
...
// 괄호 안에는 실제 웹 브라우저 화면에 표시할 내용(HTML 태그 사용가능), 어떤 결과값이 저장된 변수 삽입 가능
// document.write();
