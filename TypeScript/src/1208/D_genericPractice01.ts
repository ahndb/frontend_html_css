...
//? 회원 관리 프로그램
// : 회원을 추가(addMember), 검색(findMember), 제거(removeMember), 활성회원만 필터링(filterActiveMembers)하는 기능을 제공
...
console.log(membership.findMember('ldk')); // Member { name: 'ldk', age: 30, active: false }

// 활성 상태인 회원들만 필터링 하여 출력
